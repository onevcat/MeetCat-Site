...
const translations = {
  zh: {
    ...
    'platforms.desktop.desc': '稳定的桌面体验，后台随时待命。',
    ...
    'urlscheme.page_title': 'URL Scheme',
    'urlscheme.lead': '通过 meetcat:// URL Scheme，你可以从其它 App、脚本，或 Alfred / Raycast 这类启动器里调用 MeetCat。',
    'urlscheme.platform.title': '平台说明',
    'urlscheme.platform.text': 'URL Scheme 目前仅在 macOS 上可用。请先安装一次 MeetCat 桌面应用，让系统注册 meetcat:// 这个 scheme，然后再从其它应用里调用。',
    'urlscheme.actions.title': '可用动作',
    'urlscheme.actions.intro': '在任何能够打开 URL 的应用或脚本里，使用下面的链接：',
    'urlscheme.actions.col_url': 'URL',
    'urlscheme.actions.col_action': '动作',
    'urlscheme.actions.row_join_path': '加入会议（路径形式）。',
    'urlscheme.actions.row_join_query': '加入会议（查询参数形式）。',
    'urlscheme.actions.row_meet_mirror': '加入会议。把任意 Google Meet 链接的 https 替换为 meetcat 即可。',
    'urlscheme.actions.row_meet_lookup': '通过 Google Meet 的 lookup 链接加入会议。',
    'urlscheme.actions.row_home': '在 MeetCat 中显示 Google Meet 主页。',
    'urlscheme.actions.row_settings': '打开 MeetCat 设置窗口。',
    'urlscheme.actions.row_new': '发起一个新的即时会议。',
    'urlscheme.actions.row_check_update': '检查 MeetCat 更新。',
    'urlscheme.actions.code_note': '会议代码使用 Google Meet 的标准 xxx-xxxx-xxx 格式，例如 abc-defg-hij。',
    'urlscheme.autojoin.title': '加入行为',
    'urlscheme.autojoin.lead': '通过 URL Scheme 加入会议时，MeetCat 会沿用「自动点击加入」设置（默认开启）。',
    'urlscheme.autojoin.on': '开启时：MeetCat 会在会议准备页应用你的麦克风/摄像头默认状态，启动加入倒计时，并在倒计时结束后自动点击「加入」。',
    'urlscheme.autojoin.off': '关闭时：MeetCat 会打开会议准备页，依然应用麦克风/摄像头默认状态，但停在准备页等你手动点击「加入」。',
    'urlscheme.autojoin.override': 'URL Scheme 链接无法对单条链接覆盖此行为。如需切换，请前往 MeetCat 设置中调整「自动点击加入」。',
    'urlscheme.examples.title': '示例',
    'urlscheme.examples.terminal_label': '在终端中：',
    'urlscheme.examples.applescript_label': '在 AppleScript 或快捷指令中：',
    'urlscheme.examples.launcher_label': '在 Alfred 或 Raycast 中：',
    'urlscheme.examples.launcher_text': '配置一个「Open URL」动作，把 URL 设为 meetcat:// 链接，例如 meetcat://join/abc-defg-hij。',
  },
  ...
  en: {
    ...
    'urlscheme.page_title': 'URL Scheme',
    'urlscheme.lead': 'Drive MeetCat from other apps, scripts, and launchers (such as Alfred or Raycast) using the meetcat:// URL scheme.',
    'urlscheme.platform.title': 'Platform',
    'urlscheme.platform.text': 'URL Scheme is currently macOS-only. Install MeetCat once so the system registers the meetcat:// scheme before invoking it from other apps.',
    'urlscheme.actions.title': 'Available actions',
    'urlscheme.actions.intro': 'Open any of the URLs below from any app or script that can open URLs.',
    'urlscheme.actions.col_url': 'URL',
    'urlscheme.actions.col_action': 'Action',
    'urlscheme.actions.row_join_path': 'Join the meeting (path form).',
    'urlscheme.actions.row_join_query': 'Join the meeting (query form).',
    'urlscheme.actions.row_meet_mirror': 'Join the meeting. Replace https with meetcat in any Google Meet link.',
    'urlscheme.actions.row_meet_lookup': 'Join via a Google Meet lookup link.',
    'urlscheme.actions.row_home': 'Show the Google Meet home page in MeetCat.',
    'urlscheme.actions.row_settings': 'Open the MeetCat Settings window.',
    'urlscheme.actions.row_new': 'Start a new instant meeting.',
    'urlscheme.actions.row_check_update': 'Check for MeetCat updates.',
    'urlscheme.actions.code_note': 'Meeting codes follow the standard Google Meet format xxx-xxxx-xxx, for example abc-defg-hij.',
    'urlscheme.autojoin.title': 'Join behavior',
    'urlscheme.autojoin.lead': 'When you join a meeting via URL Scheme, MeetCat follows your Auto-click Join setting (on by default).',
    'urlscheme.autojoin.on': 'When Auto-click Join is on: MeetCat applies your mic and camera defaults on the meeting preview page, runs the join countdown, and clicks Join automatically when it ends.',
    'urlscheme.autojoin.off': 'When Auto-click Join is off: MeetCat opens the preview page and still applies your mic and camera defaults, but waits for you to click Join.',
    'urlscheme.autojoin.override': 'URL Scheme links cannot override this setting per link. Adjust Auto-click Join in MeetCat Settings if you want different behavior.',
    'urlscheme.examples.title': 'Examples',
    'urlscheme.examples.terminal_label': 'From Terminal:',
    'urlscheme.examples.applescript_label': 'From AppleScript or Shortcuts:',
    'urlscheme.examples.launcher_label': 'From Alfred or Raycast:',
    'urlscheme.examples.launcher_text': 'Configure an "Open URL" action and set the URL to a meetcat:// link, for example meetcat://join/abc-defg-hij.',
  },
  ...
  ja: {
    ...
    'urlscheme.page_title': 'URL スキーム',
    'urlscheme.lead': 'meetcat:// URL スキームを使えば、他のアプリやスクリプト、Alfred や Raycast などのランチャーから MeetCat を呼び出せます。',
    'urlscheme.platform.title': 'プラットフォーム',
    'urlscheme.platform.text': 'URL スキームは現在 macOS のみで利用できます。他のアプリから呼び出す前に、システムが meetcat:// スキームを登録できるよう、まずは MeetCat デスクトップアプリを一度インストールしてください。',
    'urlscheme.actions.title': '利用できるアクション',
    'urlscheme.actions.intro': 'URL を開けるアプリやスクリプトから、以下のいずれかの URL を開いてください。',
    'urlscheme.actions.col_url': 'URL',
    'urlscheme.actions.col_action': 'アクション',
    'urlscheme.actions.row_join_path': '会議に参加（パス形式）。',
    'urlscheme.actions.row_join_query': '会議に参加（クエリパラメータ形式）。',
    'urlscheme.actions.row_meet_mirror': '会議に参加。Google Meet のリンクの https を meetcat に置き換えるだけです。',
    'urlscheme.actions.row_meet_lookup': 'Google Meet の lookup リンク経由で会議に参加。',
    'urlscheme.actions.row_home': 'MeetCat で Google Meet のホームページを表示。',
    'urlscheme.actions.row_settings': 'MeetCat の設定ウィンドウを開きます。',
    'urlscheme.actions.row_new': 'インスタント会議を新規作成。',
    'urlscheme.actions.row_check_update': 'MeetCat のアップデートを確認。',
    'urlscheme.actions.code_note': '会議コードは Google Meet の標準フォーマット xxx-xxxx-xxx です（例：abc-defg-hij）。',
    'urlscheme.autojoin.title': '参加時の挙動',
    'urlscheme.autojoin.lead': 'URL スキームから会議に参加する場合、MeetCat は「自動で参加をクリック」設定（既定でオン）に従って動作します。',
    'urlscheme.autojoin.on': 'オンの場合：会議準備ページでマイク・カメラの初期状態を反映し、参加カウントダウンを実行して、終了時に「参加」を自動でクリックします。',
    'urlscheme.autojoin.off': 'オフの場合：会議準備ページを開いてマイク・カメラの初期状態は反映しますが、「参加」のクリックは手動で行います。',
    'urlscheme.autojoin.override': 'URL スキームのリンク単位でこの設定を上書きすることはできません。動作を変えたい場合は、MeetCat の設定で「自動で参加をクリック」を切り替えてください。',
    'urlscheme.examples.title': '例',
    'urlscheme.examples.terminal_label': 'ターミナルから：',
    'urlscheme.examples.applescript_label': 'AppleScript やショートカットから：',
    'urlscheme.examples.launcher_label': 'Alfred / Raycast から：',
    'urlscheme.examples.launcher_text': '「Open URL」アクションを設定し、URL に meetcat:// 形式のリンク（例：meetcat://join/abc-defg-hij）を指定します。',
  },
  ...
  ko: {
    ...
    'urlscheme.page_title': 'URL 스킴',
    'urlscheme.lead': 'meetcat:// URL 스킴을 사용하면 다른 앱이나 스크립트, Alfred나 Raycast 같은 런처에서 MeetCat을 호출할 수 있습니다.',
    'urlscheme.platform.title': '플랫폼',
    'urlscheme.platform.text': 'URL 스킴은 현재 macOS에서만 지원됩니다. 다른 앱에서 호출하기 전에 시스템이 meetcat:// 스킴을 등록할 수 있도록 MeetCat 데스크톱 앱을 한 번 설치해 두세요.',
    'urlscheme.actions.title': '사용 가능한 동작',
    'urlscheme.actions.intro': 'URL을 열 수 있는 모든 앱이나 스크립트에서 아래 URL 중 하나를 열어보세요.',
    'urlscheme.actions.col_url': 'URL',
    'urlscheme.actions.col_action': '동작',
    'urlscheme.actions.row_join_path': '회의에 참여 (경로 형식).',
    'urlscheme.actions.row_join_query': '회의에 참여 (쿼리 파라미터 형식).',
    'urlscheme.actions.row_meet_mirror': '회의에 참여. 모든 Google Meet 링크의 https를 meetcat으로 바꾸기만 하면 됩니다.',
    'urlscheme.actions.row_meet_lookup': 'Google Meet의 lookup 링크로 회의에 참여.',
    'urlscheme.actions.row_home': 'MeetCat에서 Google Meet 홈페이지를 표시합니다.',
    'urlscheme.actions.row_settings': 'MeetCat 설정 창을 엽니다.',
    'urlscheme.actions.row_new': '새 즉시 회의를 시작합니다.',
    'urlscheme.actions.row_check_update': 'MeetCat 업데이트를 확인합니다.',
    'urlscheme.actions.code_note': '회의 코드는 Google Meet의 표준 형식 xxx-xxxx-xxx 을 따릅니다. 예: abc-defg-hij.',
    'urlscheme.autojoin.title': '참여 동작',
    'urlscheme.autojoin.lead': 'URL 스킴으로 회의에 참여할 때 MeetCat은 "자동으로 참여 클릭" 설정(기본값: 켜짐)을 따릅니다.',
    'urlscheme.autojoin.on': '켜짐: MeetCat은 회의 준비 페이지에서 마이크와 카메라 기본 상태를 적용하고, 참여 카운트다운을 실행한 뒤 카운트다운이 끝나면 자동으로 "참여"를 클릭합니다.',
    'urlscheme.autojoin.off': '꺼짐: MeetCat은 회의 준비 페이지를 열고 마이크와 카메라 기본 상태는 적용하지만, "참여" 클릭은 사용자가 직접 해야 합니다.',
    'urlscheme.autojoin.override': 'URL 스킴 링크에서는 링크별로 이 설정을 덮어쓸 수 없습니다. 동작을 변경하려면 MeetCat 설정에서 "자동으로 참여 클릭" 옵션을 조정하세요.',
    'urlscheme.examples.title': '예시',
    'urlscheme.examples.terminal_label': '터미널에서:',
    'urlscheme.examples.applescript_label': 'AppleScript 또는 단축어에서:',
    'urlscheme.examples.launcher_label': 'Alfred / Raycast에서:',
    'urlscheme.examples.launcher_text': '"Open URL" 동작을 설정하고 URL에 meetcat:// 링크를 지정하세요. 예: meetcat://join/abc-defg-hij.',
  },
};
...
function processHtml(html, lang, config) {
  ...
  html = html.replace(
    /<a href="\/url-scheme\.html" data-i18n="nav\.url_scheme">/g,
    `<a href="${baseUrl}/url-scheme.html" data-i18n="nav.url_scheme">`
  );
  html = html.replace(
...
function generateStaticPages() {
  const rootTemplateFiles = ['index.html', 'privacy.html', 'release.html', 'tos.html', 'url-scheme.html'];
  const localizedTemplateFiles = ['index.html', 'privacy.html', 'tos.html', 'url-scheme.html'];
